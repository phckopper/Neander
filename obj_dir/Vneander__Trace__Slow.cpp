...
void Vneander::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        tracep->declBit(c+23,"i_clk", false,-1);
        tracep->declBit(c+24,"i_rst", false,-1);
        tracep->declBus(c+25,"neander OP_NOP", false,-1, 7,0);
        tracep->declBus(c+26,"neander OP_STA", false,-1, 7,0);
        tracep->declBus(c+27,"neander OP_LDA", false,-1, 7,0);
        tracep->declBus(c+28,"neander OP_ADD", false,-1, 7,0);
        tracep->declBus(c+29,"neander OP_OR", false,-1, 7,0);
        tracep->declBus(c+30,"neander OP_AND", false,-1, 7,0);
        tracep->declBus(c+31,"neander OP_NOT", false,-1, 7,0);
        tracep->declBus(c+32,"neander OP_JMP", false,-1, 7,0);
        tracep->declBus(c+33,"neander OP_JN", false,-1, 7,0);
        tracep->declBus(c+34,"neander OP_JZ", false,-1, 7,0);
        tracep->declBus(c+35,"neander OP_HLT", false,-1, 7,0);
        tracep->declBus(c+36,"neander ULA_ADD", false,-1, 2,0);
        tracep->declBus(c+37,"neander ULA_OR", false,-1, 2,0);
        tracep->declBus(c+38,"neander ULA_AND", false,-1, 2,0);
        tracep->declBus(c+39,"neander ULA_NOT", false,-1, 2,0);
        tracep->declBit(c+23,"neander i_clk", false,-1);
        tracep->declBit(c+24,"neander i_rst", false,-1);
        ...
        tracep->declBus(c+4,"neander cargaPC_val", false,-1, 7,0);
        tracep->declBit(c+21,"neander cargaPC", false,-1);
        tracep->declBit(c+22,"neander incrementaPC", false,-1);
        tracep->declBus(c+36,"neander ula ADD", false,-1, 2,0);
        tracep->declBus(c+37,"neander ula OR", false,-1, 2,0);
        tracep->declBus(c+38,"neander ula AND", false,-1, 2,0);
        tracep->declBus(c+39,"neander ula NOT", false,-1, 2,0);
        ...
        tracep->declBit(c+23,"neander PC i_clk", false,-1);
        tracep->declBit(c+24,"neander PC i_rst", false,-1);
        tracep->declBus(c+4,"neander PC i_preload", false,-1, 7,0);
        tracep->declBit(c+21,"neander PC i_preload_s", false,-1);
        tracep->declBit(c+22,"neander PC i_inc", false,-1);
...
void Vneander::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullBit(oldp+21,(vlTOPp->neander__DOT__cargaPC));
        tracep->fullBit(oldp+22,(vlTOPp->neander__DOT__incrementaPC));
        tracep->fullBit(oldp+23,(vlTOPp->i_clk));
        tracep->fullBit(oldp+24,(vlTOPp->i_rst));
        tracep->fullCData(oldp+25,(0U),8);
        tracep->fullCData(oldp+26,(1U),8);
        tracep->fullCData(oldp+27,(2U),8);
        tracep->fullCData(oldp+28,(3U),8);
        tracep->fullCData(oldp+29,(4U),8);
        tracep->fullCData(oldp+30,(5U),8);
        tracep->fullCData(oldp+31,(6U),8);
        tracep->fullCData(oldp+32,(8U),8);
        tracep->fullCData(oldp+33,(9U),8);
        tracep->fullCData(oldp+34,(0xaU),8);
        tracep->fullCData(oldp+35,(0xfU),8);
        tracep->fullCData(oldp+36,(3U),3);
        tracep->fullCData(oldp+37,(4U),3);
        tracep->fullCData(oldp+38,(5U),3);
        tracep->fullCData(oldp+39,(6U),3);
    }
}
